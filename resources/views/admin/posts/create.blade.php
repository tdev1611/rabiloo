    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-name d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted"> Add Post </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="lg-12 py-3 container">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 ">
                        <form method="POST" id="formsize" action="{{ route('admin.posts.store') }}"
                            ...
                            <div class="mb-3 col-md-10">
                                ...
                                <textarea name="desc" id="desc" cols="30" rows="10" placeholder="desc" class="form-control">{{ old('desc') }}</textarea>
                                @error('desc')
                                    <small class="text-danger">
                                        {{ $message }}
                                    </small>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    <label for="category_id" class="form-label"> categorys </label>
